...
<div class="logo">
    <a href="index.html">
        <img alt="logo" src="<c:url value="/resources/images/logo-smart.png"></c:url>" width="222" height="84"/>
        ...
        <div class="basket">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <div class="basket-item-count">
                    ...
                    <img src="<c:url value="/resources/images/icon-cart.png"></c:url>" alt="" />
                </div>
...
<!-- ============================================================= SHOPPING CART DROPDOWN : END ============================================================= -->       </div><!-- /.top-cart-row -->
    ...
    <tiles:insertAttribute name="navigationHorizontal" ignore="true" />
